...
const qnaList = [{ //E-I
        q: '1. 한 달 동안 공부, 프로젝트에 매진해 있어서 제대로 쉰 날이 하루도 없다... <b>가까스로 다 끝낸 뒤 나는?',
        a: [
    ...
    { //T-F
        q: '4. 어느날 갑자기 호빵맨이 됐다. 친한 친구가 머리를 조금 떼 줄 수 있냐고 물어본다.',
        a: [
    ...
    { //T-F
        q: '5. 팀원과 둘이서 새벽 작업 중 갑자기 정전이 됐다. 아무것도 보이지 않는다. 두꺼비집을 확인해봐야겠다.',
        a: [
    ...
    { //P-J
        q: '7. 제주도 여행을 가기로 결정했다.🌴 호텔과 항공편 예약은 끝냈으니',
        a: [
    ...
    { //T-F
        q: '11. 싫어하는 상사 : OO씨 뒤에서 욕 엄청 먹는 거 알아? 내가 진짜 OO씨 걱정돼서 얘기해주는거야.',
        a: [
